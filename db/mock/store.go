...
func (m *MockStore) AddBalanceTx(ctx context.Context, arg db.AddBalanceTxParams) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AddBalanceTx", ctx, arg)
	ret0, _ := ret[0].(error)
	return ret0
}

// AddBalanceTx indicates an expected call of AddBalanceTx.
func (mr *MockStoreMockRecorder) AddBalanceTx(ctx, arg any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AddBalanceTx", reflect.TypeOf((*MockStore)(nil).AddBalanceTx), ctx, arg)
}
...
func (m *MockStore) CreateIdempotencyKey(ctx context.Context, key string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateIdempotencyKey", ctx, key)
	ret0, _ := ret[0].(error)
	return ret0
}

// CreateIdempotencyKey indicates an expected call of CreateIdempotencyKey.
func (mr *MockStoreMockRecorder) CreateIdempotencyKey(ctx, key any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateIdempotencyKey", reflect.TypeOf((*MockStore)(nil).CreateIdempotencyKey), ctx, key)
}
