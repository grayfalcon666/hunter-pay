...
func (x *Account) GetFrozenBalance() int64 {
	if x != nil {
...
const file_account_proto_rawDesc = "" +
	"\n" +
	"\raccount.proto\x12\x02pb\x1a\x1fgoogle/protobuf/timestamp.proto\"\xf4\x01\n" +
	"\aAccount\x12\x0e\n" +
	...
	"\x11available_balance\x18\x05 \x01(\x03R\x10availableBalance\x12\x1a\n" +
	"\bcurrency\x18\x06 \x01(\tR\bcurrency\x129\n" +
	"\n" +
	"created_at\x18\a \x01(\v2\x1a.google.protobuf.TimestampR\tcreatedAtB\x0fZ\rsimplebank/pbb\x06proto3"
